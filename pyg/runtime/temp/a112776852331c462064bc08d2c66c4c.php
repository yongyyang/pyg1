<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"D:\server\pyg\pyg\public/../application/home\view\login\login.html";i:1575629246;}*/ ?>
<!DOCTYPE html>
<html>
                    ...
                    <div id="profile" class="tab-pane  active">
                        <form class="sui-form" action="<?php echo url('dologin'); ?>" method="post">
                            <div class="input-prepend"><span class="add-on loginname"></span>
                                <input id="prependedInput" type="text" name="username" placeholder="邮箱/用户名/手机号"
                                       class="span2 input-xfat">
                            </div>
                            <div class="input-prepend"><span class="add-on loginpwd"></span>
                                <input id="prependedInput" type="password" name="password" placeholder="请输入密码"
                                       class="span2 input-xfat">
                            </div>
                            <div class="setting">
                            ...
                            <div class="logined">
                                <a id="login-button" class="sui-btn btn-block btn-xlarge btn-danger"
